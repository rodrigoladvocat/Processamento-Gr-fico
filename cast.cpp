...
int main() {
    ...
    auto focal_length = 1.0;    // distance between the viewport and the camera
    ...
    auto viewport_upper_left = camera_center + vec3(0, 0, -focal_length) - viewport_u/2 - viewport_v/2; // top left corner
